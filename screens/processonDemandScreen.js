...
const ProcessonDemandPayment = ({navigation, route}) => {
  ...
  //       },
  //     };
  //     const response = await axios.get('https://www.tatd.in/app-api/customer/ondemand/get-cash-access-booking.php',config);
  //     console.log('cash option Data:', response.data);
  //       setCashoption(response.data)
  //   } catch (err) {
  //     setError(err.message);
  //     console.log('Error from cashoption API:', err.message);
  //   }
  // };
  ...
  //   try {
  //     const data = await fetchcashOptionApi();
  //     console.log('delete radeem data:', data);
  //     setApplyradeemdata(data)
  //   } catch (error) {
  //     setError(error.message);
  //   } finally {
  //     setLoading(false);
...
export default ProcessonDemandPayment;
