...
const WeeklyZoneScreen = ({ navigation }) => {
          ...
          <View style={styles.headerContainer}>
            ...
            {data.map(item => (
              <DropShadow style={{
                ...
                <TouchableOpacity key={item.id} style={styles.item} onPress={() => navigation.navigate('weeklybooking')}>
...
export default WeeklyZoneScreen;
